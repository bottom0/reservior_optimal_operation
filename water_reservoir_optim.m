function [V_opt, V_opt_num, E_eco_, Q_fd_opt, Q_qs,E_eco_stage, Hsl] = water_reservoir_optim(V_max, V_min,...
...
%           V_temp_real(q,v) 需要增加弃水
%           Q_fd_real(q,t) = E_eco(q,v)/9.81/((Z_V(V_opt(v,t+1))-308)*3600*24*tim);
        end
        end
    end
end
